...
- **Network tools** – port scanners, packet sniffers
- **Cryptography stuff** – hash crackers, encryption scripts
- **Web security** – simple SQLi and XSS testers
- **Pentesting scripts** – brute-forcers, reverse shells
